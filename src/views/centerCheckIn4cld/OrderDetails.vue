...
<script>
import orderInfo from '@/components/centerCheckIn4cld/createOrder/OrderInfo.vue'
import orderItem from '@/components/centerCheckIn4cld/createOrder/OrderItem.vue'
import itemRowEditPop from '@/components/centerCheckIn4cld/common/ItemRowEditPop.vue'
import itemSearchPop from '@/components/centerCheckIn4cld/common/itemSearchPop.vue'
export default {
	...
	methods: {
		refreshOrderDetails () {
			return this.$fxApi('centerCheckIn4cld.getOrderDetails', this.query.orderId).then(this.initOrderDetails)
		},
