<template>
	<div class="inteledi-breakBill-create">
		<w-header title="新增报损单" :border="true"></w-header>
		<orderInfo
			ref="orderInfo"
			:data="orderInfoData"
		...
		>
			<itemSearchPop
				...
				:data="searchItem"
				:isDisabled="!$fxAuth('breakBill.save')"
