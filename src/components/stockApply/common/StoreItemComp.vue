<template>
	<div class="store-item">
		<w-header title="编辑申请单明细" :leftOptions="leftOptions" @on-click-back="onCloseClick"></w-header>
...
import itemEditComp from '@/components/stockApply/common/itemEditComp.vue'
import itemInfoCell from '@/components/stockApply/common/ItemInfoCell.vue'
export default {
	name: 'storeItemComp',
	components: {
		listComp,
