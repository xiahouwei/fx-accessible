...
import addItemList from '@/components/breakBill/common/BomAddItemList.vue'
import addItemCell from '@/components/breakBill/common/BomAddItemCell.vue'
import itemNumberKeyboard from '@/components/breakBill/common/BomItemNumberKeyboard.vue'
const ITEM_SIZE = 10
export default {
	name: 'bomEditComp',
	components: {
		...
		getItem () {
			return new Promise(resolve => {
				...
				this.$fxHttp.requestPost({
					url: `${this.$fxBaseApi.url}/accounts/${this.shopId}/breakBills/details`,
					data: params,
					query: {
						m: 'getProductBomList'
					}
