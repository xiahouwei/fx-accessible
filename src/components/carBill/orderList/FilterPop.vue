	...
	<div class="filter-popup">
		...
		<div ref="filterContent" class="filter-content">
			<van-cell-group>
				...
				<van-cell title="成品仓库" :value="store" value-class="info-item-value" is-link @click="onStoreClick" />
				<van-cell title="材料仓库" :value="outHouse" value-class="info-item-value" is-link @click="onOutHouseClick" />
