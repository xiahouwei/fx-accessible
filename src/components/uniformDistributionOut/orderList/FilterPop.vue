	...
	<div class="filter-popup">
		...
		<div ref="filterContent" class="filter-content">
			<van-cell-group>
				...
				<van-cell title="配送中心" :value="rdc.name" value-class="info-item-value" is-link @click="onRdcClick" />
				<van-cell title="门店" :value="inShop.name" value-class="info-item-value" is-link @click="onInShopClick" />
				<van-cell title="仓库" :value="house.name" value-class="info-item-value" is-link @click="onHouseClick" />
		...
		<filterListPopup
			...
			title="配送中心检索"
			:rollingLoad="true"
			:getDataApi="getRdcListData"
			@on-select="selectRdc(arguments)"
		></filterListPopup>
		<filterListPopup
...
export default {
	...
	methods: {
		...
		getRdcListData (keyword = null, start, size) {
			let params = {
				keyword: keyword,
				start: start,
				size: size,
