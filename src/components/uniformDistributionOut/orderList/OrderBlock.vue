		...
		<div class="block-content">
			<div class="block-title">
				...
				<stateTag
					...
					class="state-tag"
				></stateTag>
				<i v-show="data.expressFlag" class="block-urgency fl-r"></i>
			</div>
			<div class="block-value">
				<div class="order-No">{{data.inShopDTO.name}}</div>
				<div v-show="$fxAuth('distributionOutBill.seeWithTaxMoney')" class="order-date fx-price-font">
					<span>含税金额：</span>
					<span>￥{{toFixedNumberSize(data.sumSendMoney)}}</span>
				</div>
			</div>
			<div class="block-value">
				<div class="order-No">
