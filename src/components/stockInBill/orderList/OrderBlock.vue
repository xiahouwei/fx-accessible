<template>
	<div :style="orderBlockStyle" class="order-block fx-shadow-block" @click="onClick">
		<div class="block-title">
			...
			<span class="title-text">{{data.supplierDTO.name}}</span>
		...
		<div class="block-value">
			...
			<div v-show="$fxAuth('shopStockInBill.seeWithTaxMoney')" class="order-date fx-price-font">
				<span>含税金额：</span>
		...
		<div v-if="$fxSysAuth('shopOrderBill.SysShopOrderViewHouses')" class="block-value">
			<div class="order-No">
