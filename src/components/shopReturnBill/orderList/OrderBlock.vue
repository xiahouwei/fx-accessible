	...
	<div class="order-block fx-shadow-block" @click="onClick">
		...
		<div class="block-content">
			...
			<div class="block-value">
				<div class="order-No fx-ellipsis">明细数：{{data.detailCount}}</div>
			</div>
			<div class="block-value">
				<div class="order-No fx-price-font fx-ellipsis">
					<span>含税金额：</span>
					<span>￥{{data.taxMoney}}</span>
				</div>
				<div class="order-date">
					<span>业务日期：</span>
					<span class="arr-date">{{formatterDate(data.businessDate)}}</span>
