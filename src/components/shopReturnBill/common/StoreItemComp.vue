<template>
	<div class="store-item">
		<w-header title="编辑采购退货单明细" :leftOptions="leftOptions" @on-click-back="onCloseClick"></w-header>
...
export default {
	...
	methods: {
		...
		getStoreListData (keyword = null, start, size) {
			...
			return this.$fxApi('z5common.getHouseBylist4ShopOrderBill', this.shopId)({ data: params }).then(res => {
				return res.shops
			})
		},
