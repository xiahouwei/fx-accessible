				...
				<van-tabs v-model="tabActive" animated>
					<van-tab title="表头">
						<van-cell
							...
							:is-link="!isDisabled"
							@click="onEmitClick('on-inShop-click')"
						/>
						<van-cell
							class="info-item"
							title="调入仓库"
						...
						<van-cell
							...
							title="调出机构"
							value-class="info-item-value"
							:value="data.outShopDTO && data.outShopDTO.name"
							:is-link="!isDisabled"
							@click="onEmitClick('on-outShop-click')"
						/>
						<van-cell
							class="info-item"
							title="调出仓库"
						...
						<van-cell
							...
							:is-link="!isDisabled && $fxSysAuth('shopMoveApplyBill.editWorkDate')"
...
export default {
	...
	methods: {
		...
		onBusdateClick () {
			if (!this.$fxSysAuth('shopMoveApplyBill.editWorkDate')) {
				return false
			}
