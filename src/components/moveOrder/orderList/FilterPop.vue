	...
	<div class="filter-popup">
		...
		<div ref="filterContent" class="filter-content">
			<van-cell-group>
				...
				<van-cell title="调入仓库" :value="store" value-class="info-item-value" is-link @click="onStoreClick" />
...
const ITEM_SIZE = 50
// const shopListData = require('@/json/shopList.json')
// const storeListData = require('@/json/storeList.json')
// const itemListData = require('@/json/itemList.json')
export default {
	name: 'filterPop',
	components: {
		listComp,
