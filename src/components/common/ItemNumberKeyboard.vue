		...
		<div class="number-keyboard-content">
			<div class="keyboard-number">
				...
				<div class="keyboard-number-row">
					...
					<i v-if="shortcutBtn" class="keyboard-btn-1 keyboard-btn-pre fx-Pseudo-btn" @click="preBtnClick">上一个</i>
					<i v-else class="keyboard-btn-1 fx-Pseudo-btn"></i>
				</div>
				<div class="keyboard-number-row">
					...
					<i v-if="shortcutBtn" class="keyboard-btn-1 keyboard-btn-next fx-Pseudo-btn" @click="nextBtnClick">下一个</i>
					<i v-else class="keyboard-btn-1 fx-Pseudo-btn"></i>
				</div>
			</div>
		</div>
