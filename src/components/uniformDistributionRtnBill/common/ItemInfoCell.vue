	...
	<div class="item-info-cell">
		...
		<div class="item-details">
			...
			<div class="details-cell">
				<div v-if="$fxAuth('uniformDistributionRtnBill.taxOutmoney')" class="item-taxprice fx-ellipsis">
					<span>含税金额：￥</span>
			...
			<div class="details-cell">
				...
				<div v-else class="item-amount-edit">
					...
					<div class="unit-text">
						...
						<van-icon v-show="sysUniformDistribution" name="arrow-down" />
					</div>
				</div>
			</div>
...
export default {
	...
	computed: {
		...mapState({
			...
			sysUniformDistribution: state => state.systemParams.sysUniformDistribution,
	...
	methods: {
		...
		onUnitClick () {
			if (this.isDisabled || !this.sysUniformDistribution) {
				return false
			}
