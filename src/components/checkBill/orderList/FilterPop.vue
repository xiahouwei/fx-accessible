	...
	<div class="filter-popup">
		...
		<div ref="filterContent" class="filter-content">
			<van-cell-group>
				...
				<van-cell title="盘点机构" :value="shop" value-class="info-item-value" is-link @click="onShopClick" />
				<van-cell title="盘点仓库" :value="store" value-class="info-item-value" is-link @click="onStoreClick" />
