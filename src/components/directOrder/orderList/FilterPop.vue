	...
	<div class="filter-popup">
		...
		<div ref="filterContent" class="filter-content">
			<van-cell-group>
				...
				<van-cell title="配送中心" :value="rdc" value-class="info-item-value" is-link @click="onRdcClick" />
				<van-cell title="门店" :value="shop" value-class="info-item-value" is-link @click="onShopClick" />
